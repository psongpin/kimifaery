...
const Banner: React.FC = () => {
  return (
    <Frame className="bg-pink-dark relative">
      <div className="container pt-40 pb-24 flex flex-col items-center justify-center">
        <Clock />
        <Notification />
        ...
        <motion.div
          ...
          className="container flex flex-col items-center justify-center mt-40 md:mt-40 lg:mt-64"
        >
